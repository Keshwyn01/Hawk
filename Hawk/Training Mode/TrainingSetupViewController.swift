...
class TrainingSetupViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        conditionPickerData = [["Court Surface","Hard", "Clay", "Grass", "Other"],
                               ["Weather","Indoor","Sunny","Rainy", "Other"]]
        
        strokePickerData=["Test Mode","Forehand Top Spin", "Backhand Top Spin", "Serve", "Forehand Slice", "Backhand Slice"]
    }
    ...
    /// -- Picker View Required Functions end
    ...
    func validateFields() -> String? {
        ...
        if  courtVal == 0 || weatherVal == 0 {
            return "Please fill in court and weather fields"
        }
        errorLabel.alpha=0
        return nil
    }
